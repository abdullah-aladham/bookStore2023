...
{
    /// <inheritdoc />
    public partial class BookStoreFirstMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookStoreAdmins", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookStoreUsers", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
